  ...
  return (
    <>
      ...
      <div class="padding">
        ...
        <p>Yannik Zimmermann, Website Admin</p>
        ...
        <p>
          ...
          anderen Dateien auf der Website gehören ausschliesslich der Firma IG
          Unterwilen oder den speziell genannten Rechtsinhabern. Für die
        ...
        <h2>Quelle</h2>
        <p>
          Dieses Impressum wurde am 18.02.2022 mit dem Impressum Generator der
          Webdesign Agentur{" "}
          <a href="https://webkoenig.ch/" target="_blank" rel="noreferrer">
            Webkönig
          </a>{" "}
